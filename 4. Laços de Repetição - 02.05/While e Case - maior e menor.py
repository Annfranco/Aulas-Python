import os
import sys #trás o maior valor inteiro ou menor
    ...
    match(opcao):
        case 1:
            ...
            while sexo != "F" and sexo != "M":
                print("Digite a letra correspondente ao seu sexo.")
                sexo = input("Digite o sexo (M ou F): ")
                sexo = sexo.upper()
            ...
            while salario < 0:
                print("Digite seu salário com um valot positivo.")
                salario = float(input("Digite o salário: R$"))
        ...
        case 2:
            ...
            print(f"Média de salários do grupo: R${mediaSalarios}")
